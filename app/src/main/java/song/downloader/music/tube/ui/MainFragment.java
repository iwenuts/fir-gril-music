...
import song.downloader.music.tube.admax.MaxMrec;
import song.downloader.music.tube.admax.MaxSearchBanner;
...
//        }
        ...
        if (recom == null) {
            ...
            this.tvNotice.setText("(AD) " + recom.getTitle());
            this.tvLink.setText(recom.getDesc());
            this.tvLink.setOnClickListener(new View.OnClickListener() {
                public void onClick(View view) {
                    ShareUtils.gotoRecommend(getActivity(), recom.getPackageIdWithRecom());
                }
            });
        }
    }
