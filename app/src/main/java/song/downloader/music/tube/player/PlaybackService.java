...
public class PlaybackService extends Service implements IPlayback, IPlayback.Callback {
    ...
    private static final String ACTION_PLAY_TOGGLE = "song.downloader.music.tube.ACTION.PLAY_TOGGLE";
    private static final String ACTION_PLAY_LAST = "song.downloader.music.tube.ACTION.PLAY_LAST";
    private static final String ACTION_PLAY_NEXT = "song.downloader.music.tube.ACTION.PLAY_NEXT";
    private static final String ACTION_STOP_SERVICE = "song.downloader.music.tube.ACTION.STOP_SERVICE";
