...
public class ThinDownloadManager implements DownloadManager {
     ...
     */
    private download.manager.thread.DownloadRequestQueue mRequestQueue;
    ...
    public ThinDownloadManager(boolean loggingEnabled) {
        mRequestQueue = new download.manager.thread.DownloadRequestQueue();
        mRequestQueue.start();
    ...
    public ThinDownloadManager(Handler callbackHandler) throws InvalidParameterException {
        mRequestQueue = new download.manager.thread.DownloadRequestQueue(callbackHandler);
        mRequestQueue.start();
    ...
    public ThinDownloadManager(int threadPoolSize) {
        mRequestQueue = new download.manager.thread.DownloadRequestQueue(threadPoolSize);
        mRequestQueue.start();
        setLoggingEnabled(true);
    }
